...
def make_dir(args):
    ...
    folder_name = f"{dataset}_{run_id}"
...
def run_experiments(args=None, data=None, margin=0.5, noise_reg=0.15, learning_rate=1e-3, dim=32,
                    ...
                    step_size=40, gamma=0.9, run_id=666
                    ):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--run_id",
                        type=int,
                        default=666,
                        help="run_id for storing checkpoint and training log")
    ...
    # --- 模型特定参数 ---
    parser.add_argument("--Lorentz_k",
                        type=float,
                        default=1.0,
                        help="")

    # --- CRRLoss损失函数参数 ---
    parser.add_argument("--CRR_t",
                        type=float,
                        default=1.0,
                        help="")
    parser.add_argument("--CRR_p",
                        type=float,
                        default=0.0,
                        help="")
    parser.add_argument("--CRR_w",
                        type=float,
                        default=1.0,
                        help="")

    # --- BCELoss损失函数参数 ---
    parser.add_argument("--BCE_t",
                        type=float,
                        default=1.0,
                        help="")
    parser.add_argument("--BCE_w",
                        type=float,
                        default=1.0,
                        help="")

    # --- MarginLoss损失函数参数 ---
    parser.add_argument("--positive_weight",
                        type=float,
                        default=0.01,
                        help="")
    parser.add_argument("--Margin_w",
                        type=float,
                        default=1.0,
                        help="")
    ...
    make_dir(args)
    run_experiments(args=args,data=d, margin=args.margin, noise_reg=args.noise_reg,
                    ...
                    step_size=args.step_size, gamma=args.gamma, run_id=args.run_id)