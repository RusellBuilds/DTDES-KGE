...
from data import BidirectionalOneShotIterator, SimpleBidirectionalOneShotIterator
...
def parse_args(args=None):
    ...
    parser.add_argument('--CRRLoss', action='store_true', help='Use CRR Loss')
    parser.add_argument('-CRR_p', '--CRR_p', default=0.0, type=float)
    parser.add_argument('-CRR_t', '--CRR_t', default=4.0, type=float)
...
def main(args):
    ...
    if args.model == 'ModE':
        kge_model = ModE(args, num_entity, num_relation, args.hidden_dim, args.gamma)
    elif args.model == 'HAKE':
        kge_model = HAKE(args, num_entity, num_relation, args.hidden_dim, args.gamma, args.modulus_weight, args.phase_weight)
    ...
    if args.do_train:
        ...
        train_iterator = SimpleBidirectionalOneShotIterator(train_dataloader_tail)
